...
/**
 * App 主組件
 * 展示 Preact 在 TypeScript 中的完整應用
 * 與 React 版本幾乎完全相同的代碼，但體積更小
 */
function App() {
    ...
    <div className="app">
      <div className="container">
        <header className="header">
          <h1 className="title">Preact Todo List</h1>
          <p className="subtitle">輕量級 React 替代方案 - 僅 3KB！</p>
        </header>
        ...
        <footer className="app-footer">
          <p>
            使用 <strong>Preact 10</strong> + <strong>TypeScript 5.3+</strong> +{' '}
            <strong>Vite</strong> 構建
          </p>
          <p className="tech-features">
            特色: 3KB 輕量級 • React 兼容 • Hooks 支持 • 高性能
          </p>
        </footer>
      </div>
    </div>
